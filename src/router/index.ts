    ...
    children: [
      {
        ...
        meta: { requiresAuth: true, title: 'Dashboard — ve-admin', breadcrumb: 'Dashboard' },
      },
      {
        path: 'inventory',
        name: ROUTE_NAMES.INVENTORY,
        component: () => import('@/views/dashboard/Inventory.vue'),
        meta: { requiresAuth: true, title: 'Inventory — ve-admin', breadcrumb: 'Inventory' },
      },
      {
        path: 'orders',
        name: ROUTE_NAMES.ORDERS,
        component: () => import('@/views/dashboard/Orders.vue'),
        meta: { requiresAuth: true, title: 'Orders — ve-admin', breadcrumb: 'Orders' },
      },
      {
        path: 'customers',
        name: ROUTE_NAMES.CUSTOMERS,
        component: () => import('@/views/dashboard/Customers.vue'),
        meta: { requiresAuth: true, title: 'Customers — ve-admin', breadcrumb: 'Customers' },
      },
      {
        path: 'analytics',
        name: ROUTE_NAMES.ANALYTICS,
        component: () => import('@/views/dashboard/Analytics.vue'),
        meta: { requiresAuth: true, title: 'Analytics — ve-admin', breadcrumb: 'Analytics' },
      },
      {
        path: 'promotions',
        name: ROUTE_NAMES.PROMOTIONS,
        component: () => import('@/views/dashboard/Promotions.vue'),
        meta: { requiresAuth: true, title: 'Promotions — ve-admin', breadcrumb: 'Promotions' },
      },
      {
        path: 'shipping',
        name: ROUTE_NAMES.SHIPPING,
        component: () => import('@/views/dashboard/Shipping.vue'),
        meta: { requiresAuth: true, title: 'Shipping — ve-admin', breadcrumb: 'Shipping' },
      },
      {
        path: 'storefront',
        name: ROUTE_NAMES.STOREFRONT,
        component: () => import('@/views/dashboard/Storefront.vue'),
        meta: { requiresAuth: true, title: 'Storefront — ve-admin', breadcrumb: 'Storefront' },
      },
      {
        path: 'reviews',
        name: ROUTE_NAMES.REVIEWS,
        component: () => import('@/views/dashboard/Reviews.vue'),
        meta: { requiresAuth: true, title: 'Reviews — ve-admin', breadcrumb: 'Reviews' },
      },
      {
        path: 'returns',
        name: ROUTE_NAMES.RETURNS,
        component: () => import('@/views/dashboard/Returns.vue'),
        meta: { requiresAuth: true, title: 'Returns — ve-admin', breadcrumb: 'Returns' },
      },
      {
        path: 'finance',
        name: ROUTE_NAMES.FINANCE,
        component: () => import('@/views/dashboard/Finance.vue'),
        meta: { requiresAuth: true, title: 'Finance — ve-admin', breadcrumb: 'Finance' },
      },
      {
        path: 'settings',
        name: ROUTE_NAMES.SETTINGS,
        component: () => import('@/views/dashboard/Settings.vue'),
        meta: { requiresAuth: true, title: 'Settings — ve-admin', breadcrumb: 'Settings' },
      },
    ],
  },
